...
public class Raffle {
    ...
    Raffle.ChanceCalc cc = new Raffle.ChanceCalc();
        ...
        try {
            ...
            while(kids.iterator().hasNext()){
                ...
                try {
                    ...
                    //Вывод бросков для наглядности, необязателен
    ...
    /**
     * здесь собраны методы расчет вероятности, общение с внешним классом через :
     * Outer<-Inner   Raffle.ChanceCalc cc = new Raffle.ChanceCalc()
